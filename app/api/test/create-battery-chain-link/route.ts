...
// TEMPORARY test-only route for verifying the PC-PTSD-5 gate fix and PCL-5 trigger. Uses
// createDiagnosticBatteryInstance since PC-PTSD-5 is part of the fixed Tier 1 baseline chain.
