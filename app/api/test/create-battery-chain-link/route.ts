...
// TEMPORARY test-only route for verifying the Specific Disorder Selector -> severity scale
// triggers (Panic/Agoraphobia/Social Anxiety/Separation Anxiety, Pass 2). Uses
// createDiagnosticBatteryInstance since this needs a full battery chain starting at Level 1
// XC, not a standalone link. Delete once verified.
