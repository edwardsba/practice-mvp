...
// TEMPORARY test-only route for verifying Specific Phobia's trigger from the selector's
// cluster picker (Pass 4). Uses createDiagnosticBatteryInstance since this needs a full battery
// chain starting at Level 1 XC. Delete once verified.
