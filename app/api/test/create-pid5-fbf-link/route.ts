...
// TEMPORARY test-only route for manually exercising the PID-5-FBF PD composite layer (Pass 2)
// end-to-end. Only needs clientId — practiceId and practitionerProfileId are resolved
// automatically. Delete this file once verified — not meant to ship.
